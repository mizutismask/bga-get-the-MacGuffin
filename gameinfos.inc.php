...
$gameinfos = array(
    ...
    'publisher_website' => 'http://www.looneylabs.com/',
    ...
    'presentation' => array(
        totranslate("The game Get the MacGuffin is a quick and humorous deduction game involving hand management and player elimination. The goal is to be the last player with cards. The player with the MacGuffin card will frequently win the game, but holding onto that card can prove quite difficult! Also, because there are 23 cards in the deck and players are always dealt an equal number of cards, there will always be some cards that are not in play. Figuring out which cards are missing is part of the strategy!"),
        totranslate("It was nominated for the 2019 Origins Awards Best Card Game."),
        //    ...
    ),
