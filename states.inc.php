...
$machinestates = array(
    ...
    STATE_PLAYER_TURN => array(
        ...
        "descriptionmyturn" => clienttranslate('${you} must play a card from your hand or use/discard an Object in play'),
        "type" => "activeplayer",
    ...
    STATE_CLOCKWISE_OR_NOT => array(
        ...
        "descriptionmyturn" => clienttranslate('Who\'s hand do ${you} want to receive?'),
        "type" => "activeplayer",
