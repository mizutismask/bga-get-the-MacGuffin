...
if (!defined("OBJ")) {
  ...
  //cards
  define("MACGUFFIN", "MACGUFFIN");
  define("MONEY", "MONEY");
  define("CROWN", "CROWN");
  define("BACKUP_MACGUFFIN", "BACKUP_MACGUFFIN");
  define("SCISSORS", "SCISSORS");
  define("ROCK", "ROCK");
  define("PAPER", "PAPER");
  define("MARSHALL", "MARSHALL");
  define("SHRUGMASTER", "SHRUGMASTER");
  define("INTERROGATOR", "INTERROGATOR");
  define("THIEF", "THIEF");
  define("TOMB_ROBBERS", "TOMB_ROBBERS");
  define("WHEEL_OF_FORTUNE", "WHEEL_OF_FORTUNE");
  define("SWITCHEROO", "SWITCHEROO");
  define("MERCHANT", "MERCHANT");
  define("SPY", "SPY");
  define("FIST_OF_DOOM", "FIST_OF_DOOM");
  define("GARBAGE_COLLECTR", "GARBAGE_COLLECTR");
  define("CAN_I_USE_THAT", "CAN_I_USE_THAT");
